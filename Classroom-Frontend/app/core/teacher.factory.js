(function() {
    ...
    function teacherFactory($http) {
        ...
        function create(teacher) {
            return $http.post('http://localhost:50180/api/teachers', teacher);
        }

        function getAll() {
            return $http.get('http://localhost:50180/api/teachers');
        }
        ...
        function remove(id) {
            return $http.delete('http://localhost:50180/api/teachers/' + id);
        }
    }
})();
